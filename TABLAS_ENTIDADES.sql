...
CREATE TABLE DIRECCION_COLONIA(
	CodigoPostal INT PRIMARY KEY IDENTITY NOT NULL,
	Nombre VARCHAR(50)NOT NULL,
);
GO
...
CREATE TABLE DIRECCION_USUARIOS(
	...
	FOREIGN KEY(CodigoPostal) REFERENCES DIRECCION_COLONIA(CodigoPostal),
...
GO
ALTER TABLE PRODUCTO ADD Estado BIT DEFAULT(1)
GO
