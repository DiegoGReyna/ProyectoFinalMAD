...
CREATE TABLE DIRECCION_USUARIOS(
	...
	Estado VARCHAR(50) CHECK(LEN(Estado) <= 50) NOT NULL,
	Municipio  VARCHAR(50) CHECK(LEN(Municipio) <= 50) NOT NULL,
...
CREATE TABLE USUARIOS(
	...
	Nombre VARCHAR(50) CHECK(LEN(Nombre) <= 50) NOT NULL,
	Apellido_Paterno VARCHAR(50) CHECK(LEN(Apellido_Paterno) <= 50) NOT NULL,
	Apellido_Materno VARCHAR(50) CHECK(LEN(Apellido_Materno) <= 50) NOT NULL,
	Contrasena VARCHAR(50) CHECK(LEN(Contrasena) <= 50) NOT NULL,
	Fecha_Nacimiento DATE NOT NULL,
	CURP VARCHAR(19) CHECK(LEN(CURP) = 18)NOT NULL,
...
CREATE TABLE EMPLEADO(
	...
	Usuario VARCHAR(50) CHECK(LEN(Usuario) <= 50) NOT NULL,
	RFC VARCHAR(14) CHECK(LEN(RFC) <= 14) NOT NULL,
