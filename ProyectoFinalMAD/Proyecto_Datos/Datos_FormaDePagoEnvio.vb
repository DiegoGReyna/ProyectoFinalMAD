...
Public Class Datos_FormaDePagoEnvio
    ...
    Public Function ComboBoxFormaDePago() As DataTable
        Try
            ...
            Dim Comando As New SqlCommand("PR_FormaPago_ComboBox", MyBase.conexion)
    ...
    Public Function ComboBoxFormaDeEnvio() As DataTable
        Try
            ...
            Dim Tabla As New DataTable
            'debemos de pasar el stored procedured y nuestra direccion de la conexion con la base de datos
            Dim Comando As New SqlCommand("PR_FormaEnvio_ComboBox", MyBase.conexion)
            Comando.CommandType = CommandType.StoredProcedure
            MyBase.conexion.Open()
            Resultado = Comando.ExecuteReader()
            Tabla.Load(Resultado)
