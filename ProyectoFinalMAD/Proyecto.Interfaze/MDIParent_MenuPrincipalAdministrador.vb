...
Public Class MDIParent_MenuPrincipalAdministrador
    ...
    Private Sub MDIParent_MenuPrincipalAdministrador_Load(sender As Object, e As EventArgs) Handles MyBase.Load
